...
#define SIZEOF_CHAR 1 // :D

#define SIZEOF_SIGNATURE 3      // from doc
#define SIZEOF_PAYLOADSIZE 3    // from doc
...
#define OFFSET_HEADER_FLAGS SIZEOF_SIGNATURE + SIZEOF_CHAR
#define OFFSET_PACK_PAYLOADSIZE_BE __SIZEOF_INT__ + SIZEOF_CHAR, SIZEOF_PAYLOADSIZE
#define OFFSET_PACK_STREAMIDBE __SIZEOF_INT__ + SIZEOF_CHAR + SIZEOF_PAYLOADSIZE + SIZEOF_TIMESTAMPLOWER + SIZEOF_CHAR
#define OFFSET_PACK_TIMESTAMPLOWER_BE __SIZEOF_INT__ + SIZEOF_CHAR + SIZEOF_PAYLOADSIZE
#define OFFSET_PACK_TIMESTAMPUPPER __SIZEOF_INT__ + SIZEOF_CHAR + SIZEOF_PAYLOADSIZE + SIZEOF_TIMESTAMPLOWER
